...
\033[1;96m               | |                      
\033[1;96m               |_|   TECHNICAL JAAT UPDATED 0.3                   
\033[1;91m       ♦♦♦———————————————————————————————♦♦♦
"""
def tik():
	titik = ['.   ','..  ','... ']
...
jalan("   \033[1;91m DATA USERZ USE ANY PROXY ")	

jalan("   \033[1;93m Welcome to MANKIRAT TECHNICALJAA Creations ")
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UCEHmYB_xyl71DRKqhHgjSmw')
